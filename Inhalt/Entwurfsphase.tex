...
Login-Daten. Damit lässt sich später nachvollziehen, welche fachlichen
Änderungen durchgeführt wurden und welche Anmeldevorgänge sicherheitsrelevant
waren.
...
Die Navigation führt direkt zu den Kernbereichen Dashboard, Firmen,
...
Neben der fachlichen Bedienung wurde ein Sicherheitskonzept entworfen. Dazu
...
nachvollzogen und bewertet werden. Für ausgewählte Szenarien ist außerdem ein
Rollback vorgesehen, damit unbeabsichtigte Änderungen kontrolliert
...
fachlich relevanten Aktionen einen Audit-Eintrag. So wird bei jedem Vorgang
